...
{
    public class RainfallCalculatorTest
    {
        private string data =
        ...
        private string[] towns = new string[] {"Rome", "London", "Paris", "NY", "Vancouver", "Sydney", "Bangkok", "Tokyo",
        "Beijing", "Lima", "Montevideo", "Caracas", "Madrid", "Berlin"};

        public void assertFuzzyEquals(double act, double exp)
        {
        ...
        public void MeanTest1()
        {
            ...
            //Act
            var meanResult = rainfallCalculator.Mean("London", data);

            //Assert
            assertFuzzyEquals(meanResult, 51.199999999999996);
        }
        ...
        public void MeanTest2()
        {
            ...
            //Act
            var meanResult = rainfallCalculator.Mean("Beijing", data);
        ...
        public void VarianceTest1()
        {
            ...
            //Act
            var varianceResult = rainfallCalculator.Variance("London", data);

            //Assert
            assertFuzzyEquals(varianceResult, 57.42833333333374);
        }
